...
for (const file of htmlFiles) {
    ...
    while ((match = linkRegex.exec(content)) !== null) {
        ...
        // Skip absolute URLs, mailto, tel, hash-only, and template strings/variables (e.g. ${image})
        if (link.startsWith('http://') || link.startsWith('https://') || link.startsWith('mailto:') || link.startsWith('tel:') || link.startsWith('#') || link.startsWith('javascript:') || link.includes('${')) {
            continue;
        }
